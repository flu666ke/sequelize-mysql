...
*/
        UsernameExists: async function UsernameExists(username) {
        ...
        */
        ...
        FindUser: async function (credential) {
            ...
            const user = await db.user.findOne({
                where: {
                    [Op.or]: [{ id: credential }, { username: credential }]
                }
            })
        ...
        */
        ...
        CreateUser: async function (args) {
            ...
            if (!permissions) throw new Error('Invalid argumnet: permission_id not found')
